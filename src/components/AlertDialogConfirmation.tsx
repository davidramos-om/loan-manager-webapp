...
import {
    AlertDialog, AlertDialogProps, AlertDialogBody, AlertDialogContent, AlertDialogFooter, AlertDialogHeader, AlertDialogOverlay,
    Button, ButtonProps,
    useDisclosure
...
export function AlertDialogConfirmation(props: Props) {
    const { title, description, cancelBtnText, confirmBtnText, confirmAction, cancelAction, bindComponent,
